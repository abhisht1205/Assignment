...
integer or string and expressions will be mathematical operators.* = Mathematical Operator
"hello" = String
-87.8 = Integer
...
'spam' + 'spamspam'
#This happened because addition of two strings is can be done by using + operator where two strings can be concated to become one string
...
"spam" *3
#By using  * operator we can repeat the string three times as in this case
